...
**Nimble +10% брать не стоит** — слишком слабо; 4-й слот лучше под **УПТАЙМ**, чтобы пал
не простаивал (это даёт больше выхлопа, чем +10% скорости): **Insomnia** (работает ночью,
не спит — добавляет рабочие часы), **Workaholic** (SAN −15%), **Diet Lover** (голод −15%).
game8 прямо советует транспортникам move-speed **И** food/sanity-трейты. Уптайм полезен
любому базовому рабочему (Insomnia — топ для крафтеров/шахтёров тоже).
