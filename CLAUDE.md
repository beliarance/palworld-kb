...
- `breeding_mechanics.md` — cake-рецепты, наследование пассивок, IV, Condenser (1.0: 48 копий до 4★ — кипер+47, было 116; макс за один синтез, прогресс копится), Mutation и Awakening (новое в 1.0), лучшие пассивки с цифрами.
