...
[--speed] [task1,task2 = И]    handiwork, gathering, lumbering, mining, medicine, cooling,
                              ...
                              (пал умеет ВСЕ). --speed: сортировать по скорости бега (уровень
                              качается книгами/4★, для транспорта важна скорость, а не ур.).
                              Показывает размер (XS–XL) и бег. Веб-аналог — вкладка «Рабочие»
                              (чипы-мультивыбор). NB: транспорт-уровень = сколько несёт, НЕ скорость.
